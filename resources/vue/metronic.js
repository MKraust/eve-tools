...
window.FormValidation = require("@/assets/plugins/formvalidation/dist/js/FormValidation.full.min.js");
...
require('@/assets/js/vendors/plugins/tempusdominus-bootstrap-4.init.js');
...
window.KTLayoutSearch = window.KTLayoutSearchOffcanvas = KTLayoutSearchInline = require('@/assets/js/layout/extended/search.js');
